...
Once the `conda-forge` channel has been enabled, `libsdformat11` can be installed with `conda`:
...
```
mamba install libsdformat11
```

It is possible to list all of the versions of `libsdformat11` available on your platform with `conda`:
...
```
mamba search libsdformat11 --channel conda-forge
```
...
mamba repoquery search libsdformat11 --channel conda-forge

# List packages depending on `libsdformat11`:
mamba repoquery whoneeds libsdformat11 --channel conda-forge

# List dependencies of `libsdformat11`:
mamba repoquery depends libsdformat11 --channel conda-forge
```
