...
Once the `conda-forge` channel has been enabled, `libsdformat, libsdformat14, sdformat, sdformat-python, sdformat14, sdformat14-python` can be installed with `conda`:
